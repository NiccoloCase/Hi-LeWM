...
# Usage:
#   cd jobs/train/pusht
#   sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh
#
...
#
# Optional overrides:
#   MAX_EPOCHS=15 sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh
#   LATENT_ACTION_DIM=32 sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh
#   WAYPOINT_NUM=4 WAYPOINT_STRIDE=5 sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh
#   TRAIN_RUN_NAME=hi_lewm_p2_train_latent_action_dim_32_stride_5_n4_custom sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh
#   SCRATCH_STABLEWM_HOME=/scratch-shared/$USER/stablewm_data sbatch hope2/train_latent_action_dim_32_stride_5_n4.sh

#SBATCH --partition=gpu_a100
#SBATCH --constraint=scratch-node
#SBATCH --gpus=1
#SBATCH --job-name=hi_l2_pusht_train_latent_action_dim_32_stride_5_n4
#SBATCH --ntasks=1
...
if [[ -z "${WANDB_API_KEY:-}" ]]; then
  ...
  echo "Set it in ${WANDB_ENV_FILE} or submit with: sbatch --export=ALL,WANDB_API_KEY=<your_key> hope2/train_latent_action_dim_32_stride_5_n4.sh" >&2
  exit 2
fi
...
TRAIN_RUN_NAME="${TRAIN_RUN_NAME:-hi_lewm_p2_train_latent_action_dim_32_stride_5_n4_${SLURM_JOB_ID:-manual}}"
